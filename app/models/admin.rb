class Admin < ApplicationRecord
  ...
  validates :fax_number, numericality: { only_integer: true, message: 'use single-byte number' }
  validates :fax_number, length: { maximum: 11 }
  validates :fax_number, length: { minimum: 10 }
end
